                        ...
                        <div class="flex-1 overflow-y-auto p-1 space-y-8">
                            ...
                            <div class="flex flex-col items-center justify-center space-y-4 pt-4">
                                <div class="relative group">
                                    <div
                                        class="absolute -inset-1 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-2xl blur opacity-25">
                                    </div>
                                    <div class="relative bg-white p-3 rounded-2xl shadow-sm border border-gray-100">
                                        <img src="{{ asset('image/qr_example.jpeg') }}"
                                            class="w-48 h-48 max-w-full object-contain" alt="Payment QR">
                                    </div>
                                </div>
                            ...
                            <div class="space-y-4 px-4">
                                ...
                                <div>
                                    ...
                                    <x-form.text-input name="transaction_ref" value="{{ old('transaction_ref') }}"
